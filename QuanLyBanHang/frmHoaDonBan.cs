...
namespace QuanLyBanHang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        {
            string sql;
            sql = " SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia, a.ThanhTien    FROM tblChiTietHDBan AS a    JOIN tblHang AS b ON a.MaHang = b.MaHang ";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan, NgayBan, MaNhanVien, MaKhach, TongTien) VALUES (N'" + txtMaHDBan.Text.Trim() + "',N'" +
